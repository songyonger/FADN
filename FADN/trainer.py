...
class Trainer():
    def __init__(self, args, loader, my_model, my_loss, ckp):
        ...
        if self.args.load != '':
            ...
            # for _ in range(args.resume_epoch): self.scheduler.step()
    ...
    def train(self):
        ...
        # print("self.loader_train",self.loader_train)
        # print("loader_train",len(self.loader_train))
